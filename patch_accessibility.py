...
"""
open("app/src/main/java/com/example/agent/automation/AccessibilityAutomationProvider.kt", "w").write(content)
print("Patched AccessibilityAutomationProvider.kt")
