...
ladb_content = """package com.example.agent.automation
...
"""
open("app/src/main/java/com/example/agent/automation/LadbStack.kt", "w").write(ladb_content)
print("Patched LadbStack for E1, E2, E3, W1, W2")
